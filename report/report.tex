...
\title{\textbf{Tabular Reinforcement Learning op Taxi-v4} \\
       \large Een vergelijking van Q-learning en SARSA tegen baselines}
\author{Karol Gackowski \and Joep Houweling}
\date{\today}
...
Learning algoritmen --- Q-learning en SARSA --- de Taxi-v4 omgeving uit
...
\texttt{Taxi-v4} in de Gymnasium-suite \cite{towers_2024}. De agent
...
Drie eigenschappen maken Taxi-v4 een natuurlijk doelwit voor RL en
...
Taxi-v4 ten opzichte van een random- en een heuristische baseline?
...
Taxi-v4 wordt gemodelleerd als een Markov Decision Process (MDP)
...
Q-learning en SARSA op Taxi-v4. De stippellijn geeft de theoretisch
...
Vergelijkbaar robuust over de geteste range. Voor Taxi-v4 zijn episodes
...
direct langs een gevaarlijke afgrond loopt. Op Taxi-v4 ontbreekt zo'n
...
$Q(s,a)$-cel per staat-actie-paar. Voor Taxi-v4 ($500 \times 6 = 3000$
cellen) is dit triviaal, maar in elke realistische omgeving met
cellen) is dit triviaal, maar in elke realistische omgeving met
...
\paragraph{Stochasticiteit.} Taxi-v4 is een deterministische
...
de Taxi-v4 omgeving. Q-learning bereikt $100\%$ greedy-succes met een
